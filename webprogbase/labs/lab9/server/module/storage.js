...
create = async function (x_breed,x_description,x_picture,x_facts,x_picture_type,x_picture_name) {
    let x_picture_url = (await loadImage(x_picture_type,x_picture));
    console.log("IMG "+x_picture_url);
    let sql = format("INSERT INTO maininformation(breed,description,facts,picture,picture_type,picture_name,picture_url) VALUES ($1,$2,$3,$4,$5,$6,$7)");
    //console.log(sql)
    let newAnimal = await db.query(sql,[x_breed,x_description,x_facts,x_picture,x_picture_type,x_picture_name,x_picture_url]);
    return true;
}  
